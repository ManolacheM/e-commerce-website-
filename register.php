...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['create'])) {
    ...
    $query->store_result();
        if ($query->num_rows > 0) {
            ...
            if (empty($error) ) {
                $insertQuery = $db->prepare("INSERT INTO customers (username, email, password) VALUES (?, ?, ?);");
            ...
            <fieldset>
              <div class="form">
                <div class="form-row">
                  ...
                  <input type="text"  name= "username" class="form-text" placeholder="enter your name" required>
                </div>
                <div class="form-row">
                  <i class="fas fa-envelope"></i>
                  <label class="form-label" for="input">E-mail</label>
                  <input type="email" name="email" class="form-text" placeholder="enter your e-mail" required>
                </div>
                <div class="form-row">
                ...
                <div class="form-row button-login">
                  <button name="create" class="btn btn-login">Create <i class="fas fa-arrow-right"></i></button>
                </div>
              </div>
            </fieldset>
          </form>
