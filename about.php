          ...
          <li class="nav-content-item account-login">
            <label class="open-menu-login-account" for="open-menu-login-account">
              ...
              <ul class="login-list">
                ...
                <li class="login-list-item"><a href="home.php">Logout</a></li>
                </label>
              </ul>
          </li>
        ...
        <div class="row">                
            <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                <div class="inner-column">
                    <div class="sec-title">
                        <span class="title">Despre MOTOUAU</span>
                        <h2>MAGAZIN ONLINE CU ECHIPAMENTE MOTO</h2>
                    </div>
                    <div class="text">MOTOUAU este o firma ce s-a nascut din dragostea pentru motociclism, din pasiunea pura pentru mersul pe doua roti si, din tot ce inseamna acest fenomen in cel mai larg context al sau. De altfel, credem noi, din aceleasi izvoare au luat nastere mai toate firmele din acest domeniu. MOTOUAU este intreg arealul de emotii pozitive, puse in miscare sub forma bucuriei, a libertatii, a solidaritatii si nu in ultimul rand a responsabilitatii.
                    </div>
                    <div class="text">
                      Suntem un magazin moto specializat in vanzarea de echipamente de protectie pentru motociclete, scutere si atv-uri. Firma noastra gazduieste o echipa tanara, entuziasta, cu o filozofie orientata in mod prioritar in satisfactia clientului, interesata sa ofere cele mai bune servicii si produse de calitate la preturi accesibile. 
                    </div>
                    <div class="text">
                      Iti oferim din stoc sau la comanda, o gama variata de casti, geci, pantaloni, combinezoane, manusi si cizme moto de la producatori renumiti precum Scorpion, Ixs, Spyke, Nolan, Thor, Fox, Icon, Alpinestars, VR46. Produse omologate, de calitate superioara, tot ce ai nevoie pentru tine si motorul tau. Consultantii nostrii te vor ajuta in alegerea echipamentului potrivit, suntem la dispozitia ta pentru a-ti crea o experienta de cumparare cat mai placuta!
                    </div>
                      <div class="btn-box">
